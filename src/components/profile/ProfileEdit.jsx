    ...
    <div className="space-y-8 animate-fade-in max-w-6xl mx-auto pb-10">
      ...
      <div className="relative overflow-hidden bg-slate-900 rounded-[2.5rem] p-8 sm:p-10 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)] flex flex-col sm:flex-row justify-between items-start sm:items-center">
        ...
        <div className="relative z-10 mb-6 sm:mb-0">
          ...
          <p className="text-slate-400 text-lg max-w-2xl leading-relaxed">
            Керуйте своїми персональними та антропометричними даними.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
        ...
        <div className="xl:col-span-8 space-y-6">
          <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] border border-slate-200/60 dark:border-slate-800 shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-8 sm:p-10">
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-start space-y-4 sm:space-y-0 sm:space-x-6 mb-10 pb-8 border-b border-slate-100 dark:border-slate-800">
              <div className="w-28 h-28 rounded-[2rem] bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center text-white text-5xl font-bold shadow-lg shadow-blue-500/20 flex-shrink-0">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 animate-fade-in">
                ...
                <div className="flex flex-col p-5 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-100 dark:border-slate-700/50">
                  ...
                  <div className="text-2xl font-black text-slate-900 dark:text-white">
                    {userData?.height || '-'} <span className="text-sm font-medium opacity-50 ml-1">см</span>
                  </div>
                </div>
                ...
                <div className="flex flex-col p-5 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-100 dark:border-slate-700/50">
                  ...
                  <div className="text-2xl font-black text-slate-900 dark:text-white">
                    {userData?.weight || '-'} <span className="text-sm font-medium opacity-50 ml-1">кг</span>
                  </div>
                </div>
                ...
                <div className="flex flex-col p-5 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-100 dark:border-slate-700/50">
                  ...
                  <div className="text-2xl font-black text-slate-900 dark:text-white">
                    {calculateAge()} <span className="text-sm font-medium opacity-50 ml-1">років</span>
                  </div>
                </div>
        ...
        <div className="xl:col-span-4 space-y-6">
          <div className={`bg-white dark:bg-slate-900 rounded-[2.5rem] border ${bmiCategory.text !== '-' ? `border-${bmiCategory.color}-200 dark:border-${bmiCategory.color}-900/50` : 'border-slate-200/60 dark:border-slate-800'} shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-8 overflow-hidden relative transition-colors duration-500`}>
            ...
            <div className="mt-6 flex items-start space-x-3 p-4 bg-sky-50 dark:bg-sky-500/10 rounded-2xl border border-sky-100 dark:border-sky-500/20 relative z-10">
              <Info className="w-5 h-5 text-sky-500 flex-shrink-0 mt-0.5" />
              <p className="text-xs text-sky-700 dark:text-sky-300/80 leading-relaxed font-medium">
                BMI є загальним показником. Для професійної оцінки складу тіла проконсультуйтеся з вашим лікарем.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="p-5 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-100 dark:border-slate-700/50">
            ...
            <p className="text-slate-900 dark:text-white font-semibold flex items-center">
              {userData?.role === 'admin' ? (
                <span className="px-2.5 py-1 bg-rose-100 text-rose-700 dark:bg-rose-500/20 dark:text-rose-400 rounded-md text-xs">Адміністратор</span>
              ) : (
